...
TOKEN = '8025220929:AAFSoqmmcn5zduWmrJBy1bsLX1UNtgj-ejg'
...
def create_inline_keyboard():
    ...
    button = InlineKeyboardButton(text="OWNER", url="https://t.me/Mahi_op_0")
    keyboard.add(button)
    return keyboard
...
/clearlogs : Clear The Logs File.
    ...
    keyboard = InlineKeyboardMarkup()
    button = InlineKeyboardButton(text="Owner", url="https://t.me/Mahi_op_0")  # Owner button URL
    keyboard.add(button)
